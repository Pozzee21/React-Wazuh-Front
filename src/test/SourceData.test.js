...
import SoruceData from '../Components/SoruceData';
...
const component = render(<Agent Datashow={agentedata.Datashow}/>);

const date =component.getByText('2020-09-16T02:29:46.344+0000');
const id = component.getByText('1580123327.49031')
const sha256 = component.getByText('ff9a6a109a9a5584752c74ecbbb82bed50231d795da85daad7782138a23e')
...
expect(id).toHaveTextContent;
expect(sha256).toHaveTextContent;
  const ip =component.getByText('Ip: No data found');
  const button = component.getByText('View all agents')
  const name = component.getByText('Name: No data found')
